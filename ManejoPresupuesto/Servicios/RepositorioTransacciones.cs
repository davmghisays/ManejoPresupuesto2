...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class RepositorioTransacciones : IRepositorioTransacciones
    {
        ...
        /*Aqui se obtiene la Primera Transaccion buscando por un Id y un usuario.
            Además, se obtiene*/
        ...
        public async Task<IEnumerable<ResultadoObtenerPorSemana>> ObtenerPorSemana(ParametroObtenerTransaccionesPorUsuario modelo)
        {
            ...
            /*Esta función se encarga de recolectar los datos de las transacciones, obteniendo los datos por semana,
             por sumando montos y clasificando por tipos de operacion (ingresos y gastos)*/
            using var connection = new SqlConnection(connectionString);
